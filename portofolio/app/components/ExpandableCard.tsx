...
const ExpandableCard = ({ className, children } : PropsWithChildren<{className?: string}> ) => {
            ...
            <div className="flex justify-center items-center mt-5">
                ...
                <motion.div layout="position" className="">
                    ...
                    <button 
                        ...
                        <ArrowDown className={`fill-white size-4 transition-transform duration-1000 ${isOpen ? 'rotate-180' : ''}`}/>
